...
(function () {
	...
	/*Top full toast js */
	const topfullToast = document.getElementById('topfullwidthToastBtn')
	const topfulltoastExample = document.getElementById('topfullwidth-Toast')
	if (topfullToast) {
		topfullToast.addEventListener('click', () => {
			const toast = new bootstrap.Toast(topfulltoastExample)
			toast.show()
		})
	}
	...
	/*Middle full toast js */
	const middlefullToast = document.getElementById('middlefullwidthToastBtn')
	const middlefulltoastExample = document.getElementById('middlefullwidth-Toast')
	if (middlefullToast) {
		middlefullToast.addEventListener('click', () => {
			const toast = new bootstrap.Toast(middlefulltoastExample)
			toast.show()
		})
	}
	...
	/*Bottom right toast js */
	const bottomfullToast = document.getElementById('bottomfullwidthToastBtn')
	const bottomfulltoastExample = document.getElementById('bottomfullwidth-Toast')
	if (bottomfullToast) {
		bottomfullToast.addEventListener('click', () => {
			const toast = new bootstrap.Toast(bottomfulltoastExample)
			toast.show()
		})
	}
