                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="header-element country-dropdown dropdown-center">
                                    ...
                                    <a href="javascript:void(0);" class="header-link dropdown-toggle"
                                        ...
                                        <img src="{{ asset('template/') }}assets/images/flags-img/us_flag.jpg"
                                    ...
                                    <div class="main-header-dropdown dropdown-menu dropdown-menu-end"
                                        ...
                                        <ul class="mb-0">
                                            <li class="dropdown-item mb-1">
                                                <div class="d-flex align-items-center">
                                                    <div class="pe-2">
                                                        <img src="{{ asset('template/') }}assets/images/flags-img/india_flag.jpg"
                                            ...
                                            <li class="dropdown-item mb-1">
                                                <div class="d-flex align-items-center">
                                                    <div class="pe-2">
                                                        <img src="{{ asset('template/') }}assets/images/flags-img/malaysia.jpg"
                                                            class="rounded-circle country-img" alt="img">
                                                    </div>
                                                    <div class="flex-grow-1">
                                            ...
                                            <li class="dropdown-item mb-1">
                                                <div class="d-flex align-items-center">
                                                    <div class="pe-2">
                                                        <img src="{{ asset('template/') }}assets/images/flags-img/italy_flag.jpg"
                                                            class="rounded-circle country-img" alt="img">
                                                    </div>
                                                    <div class="flex-grow-1">
                                            ...
                                            <li class="dropdown-item mb-1">
                                                <div class="d-flex align-items-center">
                                                    <div class="pe-2">
                                                        <img src="{{ asset('template/') }}assets/images/flags-img/argentina.jpg"
                                                            class="rounded-circle country-img" alt="img">
                                                    </div>
                                                    <div class="flex-grow-1">
                                            ...
                                            <li class="dropdown-item mb-1">
                                                <div class="d-flex align-items-center">
                                                    <div class="pe-2">
                                                        <img src="{{ asset('template/') }}assets/images/flags-img/turkey.jpg"
                                                            class="rounded-circle country-img" alt="img">
                                                    </div>
                                                    <div class="flex-grow-1">
